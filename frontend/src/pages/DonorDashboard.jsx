...
const DonorDashboard = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate 2-second AI Smart NGO Matching process
    setTimeout(() => {
      setStep('success');
    }, 2000);
  };
  ...
  return (
    <div className="pt-20 pb-20 sm:pb-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-green-950 via-green-900 to-orange-600 text-white rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-2 border-green-700/40">
        <div className="space-y-2 max-w-xl">
          <div className="inline-flex items-center space-x-2 bg-white/20 px-3 py-1 rounded-full text-[11px] font-black backdrop-blur-md text-orange-200 uppercase tracking-widest">
      ...
      {step === 'form' && (
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-5 sm:p-8 shadow-xl border border-emerald-900/10 space-y-7">
          ...
          {/* PRIMARY MOBILE BUTTON — STICKY TOUCH FRIENDLY */}
          <button
            type="submit"
      ...
      {step === 'matching' && (
        <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-emerald-900/10 text-center space-y-6 animate-in zoom-in-95">
      ...
      {step === 'success' && (
        <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-xl border border-emerald-900/10 space-y-6 animate-in fade-in">
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-8 shadow-xl border border-emerald-900/10 space-y-4">
