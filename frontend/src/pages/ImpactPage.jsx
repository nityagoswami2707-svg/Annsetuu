    ...
    <div className="pt-24 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <span className="text-xs font-bold uppercase tracking-widest text-amber-600 bg-amber-100 px-3.5 py-1 rounded-full border border-amber-200">
          Quantifiable Humanitarian Results
        </span>
        <h1 className="text-4xl sm:text-6xl font-black font-outfit text-emerald-950">
          Our Collective Social Impact
        </h1>
        <p className="text-base text-gray-700 leading-relaxed">
          Every meal rescued bridges surplus food with human dignity. Here is how Annsetu is transforming communities across Gujarat.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-emerald-900 via-emerald-800 to-amber-700 text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 text-xl sm:text-3xl font-black font-outfit pt-2">
          ...
          <span className="text-amber-400 text-2xl">→</span>
          <div className="p-4 bg-amber-400 text-gray-950 rounded-2xl shadow-lg">
            50 Bright Smiles ❤️
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 text-center">
        ...
        <div className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-md">
          ...
          <p className="text-xs font-bold text-gray-500 uppercase mt-1">Meals Saved</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-md">
          ...
          <p className="text-xs font-bold text-gray-500 uppercase mt-1">People Served</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-md">
          ...
          <p className="text-xs font-bold text-gray-500 uppercase mt-1">NGOs Connected</p>
        </div>

        <div className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-md">
          <Users className="w-8 h-8 mx-auto text-purple-600 mb-2" />
          <p className="text-3xl font-black text-emerald-950 font-outfit">120+</p>
          <p className="text-xs font-bold text-gray-500 uppercase mt-1">Active Donors</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-md">
          ...
          <p className="text-xs font-bold text-gray-500 uppercase mt-1">Cities Covered</p>
        </div>

        <div className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-md">
          <Award className="w-8 h-8 mx-auto text-amber-500 mb-2" />
          <p className="text-3xl font-black text-emerald-950 font-outfit">85+</p>
          <p className="text-xs font-bold text-gray-500 uppercase mt-1">Volunteers Engaged</p>
        </div>
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-black font-outfit text-emerald-950">Stories of Hope & Transformation</h2>
          <p className="text-xs text-gray-500">Real feedback from restaurant owners, NGO directors, and logistics partners.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t, idx) => (
            <div key={idx} className="bg-white p-6 rounded-3xl border border-emerald-900/10 shadow-lg flex flex-col justify-between space-y-4">
              ...
              <div className="flex items-center space-x-3 pt-4 border-t border-gray-100">
                <img src={t.avatar} alt={t.name} className="w-11 h-11 rounded-full object-cover border border-gray-200" />
                <div>
                  <h4 className="text-xs font-bold text-emerald-950 font-outfit">{t.name}</h4>
