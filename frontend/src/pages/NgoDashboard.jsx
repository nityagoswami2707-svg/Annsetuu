...
const NgoDashboard = () => {
  ...
  return (
    <div className="pt-24 pb-20 sm:pb-16 min-h-screen bg-gradient-to-b from-green-950 via-emerald-950 to-green-900 text-white relative overflow-hidden">
      ...
      <div className="absolute top-10 right-10 w-96 h-96 bg-emerald-500/20 rounded-full filter blur-3xl pointer-events-none motion-bg-particle-1"></div>
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-orange-500/15 rounded-full filter blur-3xl pointer-events-none motion-bg-particle-2"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
        
        {/* Header Banner */}
        <div className="bg-gradient-to-r from-emerald-950 via-green-900 to-emerald-950 text-white rounded-3xl p-5 sm:p-8 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border border-emerald-700/80">
          <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="bg-white/95 backdrop-blur-md text-gray-900 p-4 rounded-2xl border border-emerald-500/30 shadow-md card-zoom-3d">
        ...
        {/* NGO Tabs Navigation */}
        <div className="flex flex-wrap gap-2 border-b border-emerald-800/80 pb-3">
          <button
            onClick={() => setActiveTab('requests')}
            className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all tab-animated ${
              activeTab === 'requests' ? 'bg-amber-500 text-gray-950 font-black shadow-md' : 'bg-emerald-900/80 text-emerald-100 border border-emerald-700'
            }`}
          >
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all tab-animated ${
              activeTab === 'accepted' ? 'bg-amber-500 text-gray-950 font-black shadow-md' : 'bg-emerald-900/80 text-emerald-100 border border-emerald-700'
            }`}
          >
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all tab-animated ${
              activeTab === 'register' ? 'bg-orange-500 text-gray-950 font-black shadow-md' : 'bg-emerald-900/80 text-emerald-100 border border-emerald-700'
            }`}
          >
            + Register NGO
          </button>
        ...
        {activeTab === 'requests' && (
          <div className="space-y-4">
            <h3 className="text-base sm:text-lg font-black font-outfit text-white">Incoming Food Requests</h3>
            
            {pendingRequests.length === 0 ? (
              <div className="bg-white/95 text-gray-900 p-8 rounded-3xl text-center border border-emerald-100 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {pendingRequests.map(item => (
                  <div key={item.id} className="bg-white/95 backdrop-blur-md text-gray-900 rounded-3xl border border-emerald-500/30 shadow-xl p-5 space-y-3.5 card-zoom-3d">
        ...
        {activeTab === 'accepted' && (
          <div className="space-y-3">
            <h3 className="text-base font-black font-outfit text-white">Active Accepted Pickups</h3>
        ...
        {activeTab === 'register' && (
          <form onSubmit={handleNgoSubmit} className="bg-white/95 text-gray-900 rounded-3xl p-6 border border-emerald-500/30 shadow-2xl space-y-4 max-w-lg mx-auto">
