        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-green-900/60">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-orange-300 font-bold">{t('tagline')}</p>
              </div>
            </div>
            ...
            <div className="flex space-x-3 pt-2">
              <a href="#twitter" aria-label="Twitter" className="w-9 h-9 rounded-full bg-green-900/80 hover:bg-orange-500 hover:text-white flex items-center justify-center transition-colors tab-animated">
                <Twitter className="w-4 h-4" />
              </a>
              <a href="#facebook" aria-label="Facebook" className="w-9 h-9 rounded-full bg-green-900/80 hover:bg-orange-500 hover:text-white flex items-center justify-center transition-colors tab-animated">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="#instagram" aria-label="Instagram" className="w-9 h-9 rounded-full bg-green-900/80 hover:bg-orange-500 hover:text-white flex items-center justify-center transition-colors tab-animated">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="#linkedin" aria-label="LinkedIn" className="w-9 h-9 rounded-full bg-green-900/80 hover:bg-orange-500 hover:text-white flex items-center justify-center transition-colors tab-animated">
          ...
          <div>
            <h4 className="text-sm font-bold font-outfit text-white uppercase tracking-wider mb-4 border-l-2 border-orange-400 pl-2">
              {t('platformLinksHeader')}
            </h4>
            <ul className="space-y-2.5 text-xs">
              <li><Link to="/" className="hover:text-orange-300 transition-colors">{t('home')}</Link></li>
              <li><Link to="/donor" className="hover:text-orange-300 transition-colors">{t('donateFood')}</Link></li>
